    ...
    >
      <Grid container spacing={2}>
        <Typography
          ...
          >
          Développeuse web full-stack diplômée d’un <strong style={{fontFamily: "Melodrama-Bold", color: '#e6dded'}}> Master </strong> en développement informatique,
          je suis passionnée par la conception de solutions innovantes. Mon expertise en <strong style={{fontFamily: "Melodrama-Bold", color: '#e6dded'}}> React.js </strong>
          pour le front-end, et en <strong style={{fontFamily: "Melodrama-Bold", color: '#e6dded'}}> C# .NET </strong> pour le back-end, me permet d’aborder des projets
